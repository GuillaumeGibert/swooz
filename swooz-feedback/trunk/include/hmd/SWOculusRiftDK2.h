...
#ifndef _SWOCULUSRIFTDK2_
#define _SWOCULUSRIFTDK2_
...
class SWOculusRiftDK2
{
    public:
        ...
        /**
         * @brief SWOculusRiftDK2
         */
        SWOculusRiftDK2(){m_fullScreen = false; m_eyeToDisplay = 0;}
