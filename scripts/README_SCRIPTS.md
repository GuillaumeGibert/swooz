...
This script creates all the ../dist file tree :
		../dist/bin
		../dist/include
		../dist/lib
		../dist/data
...
IMPORTANT : do not change the build order of the projects, and do not comment SW_toolkit, its contains numerous 
functions used in the others projects and the build may be not working.
